        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                <div class="dropdown-menu dropleft" x-placement="left-start" style="position: absolute; transform: translate3d(-2px, 0px, 0px); top: 0px; left: 0px; will-change: transform;">
                  <a class="dropdown-item" href="' . route('admin.product-gallery.show', $query->id) . '">Product Gallery</a>
                  <a class="dropdown-item" href="' . route('admin.product-size.show', $query->id) . '">Product Variants</a>
                </div>
              </div>';
